...
output.folder <- "ssp_modeling/ssp_run_output/sisepuede_results_run_sisepuede_run_2025-07-23T16;44;34.512127/"
dir.data <- paste0(output.folder)
file.name <- "sisepuede_results_sisepuede_run_2025-07-23T16;44;34.512127_WIDE_INPUTS_OUTPUTS.csv"
...
write.csv(test2,"ssp_modeling/Tableau/data/drivers_tanzania_250821.csv", row.names=FALSE)
